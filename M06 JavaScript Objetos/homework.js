...
function invocarMetodo(objeto, metodo) {
   ...
   if (objeto.hasOwnProperty(metodo) && typeof objeto[metodo] === 'function') {
      ...
      console.log('El método especificado no existe en el objeto o no es una función.');
    }
}
...
function rLikesDeUsuario(objetoUsuario) {
   // El parámetro "objetoUsuario" tiene una propiedad llamada "posts" que es un arreglo.
   // Este arreglo contiene objetos (post).
   // Cada post posee una propiedad llamada "likes". Esta propiedad es un número.
   // Debes sumar los likes de todos los post y retornar el resultado.suma
   // Tu código:
   if (Array.isArray(objetoUsuario.posts)) {
      const sumaLikes = objetoUsuario.posts.reduce((acumulador, post) => {
